...
from vlm.datasets.evaluation import RESDataset

# choose one
# from vlm.engine.runner import VideoTestLoop
from vlm.engine.runner import TestLoop as VideoTestLoop

from mmengine.dataset import DefaultSampler
from transformers import CLIPImageProcessor

from vlm.models import QwenVL2
from vlm.models.qwen2_vl import Qwen2VLImageProcessor
...
#######################################################################
# Model
path = './pretrained/qwen/Qwen2-VL-2B-Instruct'
...
preprocessor = dict(
    type=Qwen2VLImageProcessor.from_pretrained,
    pretrained_model_name_or_path=path,
    trust_remote_code=True,
)
...
test_evaluator = dict()
test_cfg = dict(type=VideoTestLoop, select_metric='first')
