...
from projects.llava_sam2.datasets import VideoReVOSEvalDataset, DAVISEval, VideoMeVISDataset, VideoRefYoutubeVOSDataset, video_lisa_collate_fn, VideoRefSAM2EvalDataset
...
#######################################################################
# Model
path = './pretrained/internvl/InternVL2-26B/'
...
############### video res
data_root_revos = '/mnt/bn/xiangtai-training-data-video/dataset/video_vlm/video_res/revos/'
...
data_root_refytvos = '/mnt/bn/xiangtai-training-data-video/dataset/video_vlm/video_res/rvos/'
...
############ DAVIS eval ############
data_root_davis = '/mnt/bn/xiangtai-training-data-video/dataset/video_vlm/video_res/davis17/'
...
########### MeVIS eval ############
data_root_mevis_val = '/mnt/bn/xiangtai-training-data-video/dataset/video_vlm/video_res/mevis/valid_u/'
...
data_root_refsam2 = './ref_sam2/'
video_refsam2_image_folder = data_root_refsam2 + 'videos/'
video_refsam2_expression_file = data_root_refsam2 + 'meta_expressions_valid.json'
video_refsam2_mask_file = data_root_refsam2 + 'mask_dict.json'
...
test_dataset = [
    ...
    # ),
    # dict(
    #     type=VideoRefSAM2EvalDataset,
    #     image_folder=video_refsam2_image_folder,
    #     expression_file=video_refsam2_expression_file,
    #     mask_file=video_refsam2_mask_file,
    #     tokenizer=tokenizer,
    #     template_map_fn=dict(type=template_map_fn_factory, template=prompt_template),
    #     max_length=max_length,
    #     lazy=True,
