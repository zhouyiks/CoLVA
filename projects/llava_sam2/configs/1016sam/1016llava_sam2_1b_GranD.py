...
from projects.llava_sam2.datasets import GranDDataset
...
grand_dataset = dict(
    type=GranDDataset,
    image_folder="/mnt/bn/xiangtai-training-data-video/dataset/segmentation_datasets/sam_full/",
    json_folder="/mnt/bn/xiangtai-training-data-video/dataset/video_vlm/grand/",
    tokenizer=tokenizer,
    max_length=max_length,
    special_tokens=special_tokens,
    template_map_fn=dict(type=template_map_fn_factory, template=prompt_template),
