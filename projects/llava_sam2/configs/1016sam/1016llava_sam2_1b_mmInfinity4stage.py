...
from projects.llava_sam2.datasets import LLaVADataset, InfinityMMDataset
...
infinity_dataset = dict(
    type=InfinityMMDataset,
    tokenizer=tokenizer,
    data_path='/mnt/bn/xiangtai-training-data-video/infinity-mm/stage4/',
    prompt_template=prompt_template,
    special_tokens=special_tokens,
    max_length=max_length,
)
