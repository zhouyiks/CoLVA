...
from projects.mllm_labeling.datasets.text_dataset_vertify import SAM2TextDataset_Filter_Unindentified
...
save_folder = './whole_pesudo_cap_v3/sav_008_014_step1/'

# Data paths
json_folder = './whole_pesudo_cap_v3/sav_008_014_step0/'
...
test_dataset = [dict(
    type=SAM2TextDataset_Filter_Unindentified,
