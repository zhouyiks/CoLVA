...
def image_video_collate_fn(instances: Sequence[Dict],
    ...
    for example in instances:
        ...
        if has_image:
            if isinstance(example['pixel_values'], list):
                ...
                per_batch_image_nums.append(len(example['pixel_values']))
            else:
                pixel_values.append(example['pixel_values'])
                per_batch_image_nums.append(1)
    ...
    if has_image:
        ...
        data_dict['per_batch_image_nums'] = per_batch_image_nums
