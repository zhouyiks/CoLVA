...
def load_checkpoint(model, checkpoint_path, strict=True):
    ...
    # for zero3, skip parameters not on this GPU
    state_dict_current = model.state_dict()
    state_dict_ = {}
    for key in state_dict.keys():
        parameter_current = state_dict_current[key]
        if len(parameter_current.shape) == 0 or parameter_current.shape[0] != 0:
