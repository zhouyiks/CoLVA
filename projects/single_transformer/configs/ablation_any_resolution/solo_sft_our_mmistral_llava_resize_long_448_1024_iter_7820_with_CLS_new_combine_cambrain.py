...
from projects.single_transformer.models.solo_image_processor import SoloCLIPImageProcessor
...
#######################################################################
# Model
llm_name_or_path = '/mnt/bn/bytenas-weixian/ckpt/exp_ckpt/cont_pt_anyres/iter_7820_hf'
...
data_root_llava_onevision = '/mnt/bn/xiangtai-training-data-video/dataset/LLaVA-OneVision/'
data_path_llava_onevision = data_root_llava_onevision + 'cambrian_filtered_processed.json'
image_folder_llava_onevision = data_root_llava_onevision
...
llava_one_vision_dataset = dict(
    type=LLaVADataset,
    data_path=data_path_llava_onevision,
    image_folder=image_folder_llava_onevision,
    tokenizer=tokenizer,
    image_processor=image_processor,
    dataset_map_fn=llava_map_fn,
    template_map_fn=dict(
...
train_dataset = dict(
    type=CombineDataset,
    datasets_cfgs=[llava_dataset, llava_one_vision_dataset],
    exhibit_special_tokens=True,
)
