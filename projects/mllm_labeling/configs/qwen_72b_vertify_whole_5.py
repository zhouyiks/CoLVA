...
from projects.mllm_labeling.datasets.text_dataset_vertify import SAM2TextDataset_Vertify, SAM2TextDataset_Vertify_whole
...
save_folder = './whole_pesudo_cap/folder8-9_filter/'

# Data paths
json_folders = ['./whole_pesudo_cap/folder8/', './whole_pesudo_cap/folder9/']
...
test_dataset = [dict(
    type=SAM2TextDataset_Vertify_whole,
