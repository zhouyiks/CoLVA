...
class Qwen2VLCombineDataset(Dataset):
    def __init__(self,
                 datasets_cfgs,
        ...
        if ot_image_processor:
            ...
            ot_image_processor = None
        if qwen2_processor:
            qwen2_processor_clazz = qwen2_processor.pop('type')
            self.qwen2_processor = qwen2_processor_clazz(**qwen2_processor)
        else:
            self.qwen2_processor = None
        ...
        for dataset_cfg in datasets_cfgs:
            ...
            dataset_cfg.update(dict(ot_image_processor=ot_image_processor,
                                    qwen2_processor=self.qwen2_processor,
