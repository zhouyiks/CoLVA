...
from projects.mllm_labeling.datasets.demo_dataset import DemoImageCap_WholeCap
...
save_folder = './1215_demos/sense_cap/'
...
test_dataset = [dict(
    type=DemoImageCap_WholeCap,
    image_folder='/mnt/bn/xiangtai-training-data/project/xiangtai-windows/tt_vlm/1215_demos/overall_demos/',
    bs=1,
)]
