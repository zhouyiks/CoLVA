...
from projects.omg_llava.model import OMG_LLaVA, OpenCLIPBackbone_omgseg, OMGSegVisualEncoder,\
    Mask2FormerVideoSemSamHead
...
llm_name_or_path = './pretrained/omg_llava/Qwen2-57B-A14B-Instruct' # Please change to your own path
