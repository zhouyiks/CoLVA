...
from projects.mllm_labeling.datasets.text_dataset_vertify import SAM2TextDataset_Formatting_whole
...
save_folder = './whole_pesudo_cap/formatted/'

# Data paths
json_folders = ['./whole_pesudo_cap/summarized/']
...
test_dataset = [dict(
    type=SAM2TextDataset_Formatting_whole,
