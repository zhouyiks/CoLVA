...
from projects.mllm_labeling.datasets.text_dataset_vertify import SAM2TextDataset_Translation
...
save_folder = './whole_pesudo_cap_v3/sav_054_step6/'

# Data paths
json_folder = './whole_pesudo_cap_v3/sav_054_step5/'
...
test_dataset = [dict(
    type=SAM2TextDataset_Translation,
