...
if not os.path.exists("./manual_check_visualization"):
    os.mkdir("./manual_check_visualization")
if not os.path.exists("./manual_check_visualization/{}".format(args.folder_name)):
    os.mkdir('./manual_check_visualization/{}'.format(args.folder_name))

video_folder = '/mnt/bn/xiangtai-training-data-video/dataset/segmentation_datasets/sam_v_full'
video_save_path = "./manual_check_visualization/{}/demo.mp4".format(args.folder_name)
