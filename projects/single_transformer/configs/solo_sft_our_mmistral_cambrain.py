...
#######################################################################
# Model
llm_name_or_path = '/mnt/bn/xiangtai-training-data-video/models/iter3124_hf'
...
data_root_cambrain = './data/Cambrian-10M/'
data_path_cambrain = data_root_cambrain + 'jsons/Cambrian7M_withsystemprompt.jsonl'
...
cambrain_dataset = dict(
    type=LLaVADataset,
    data_path=data_path_cambrain,
    image_folder=data_root_cambrain,
    tokenizer=tokenizer,
    image_processor=image_processor,
    dataset_map_fn=llava_map_fn,
    template_map_fn=dict(
...
# train_dataset = dict(
#     type=CombineDataset,
#     datasets_cfgs=[llava_dataset, cambrain_dataset],
#     exhibit_special_tokens=True,
# )
