...
from projects.single_transformer.models.modeling_qwen2mm import Qwen2MMForCausalLM
...
#######################################################################
# Model
llm_name_or_path = '/mnt/bn/bytenas-weixian/ckpt/exp_ckpt/qwen2-1.5B/cotrain_s1_pretrain/iter_4810_hf'
...
model = dict(
    ...
    tokenizer=tokenizer,
    llm=dict(
        type=Qwen2MMForCausalLM.from_pretrained,
        pretrained_model_name_or_path=llm_name_or_path,
        trust_remote_code=True,
