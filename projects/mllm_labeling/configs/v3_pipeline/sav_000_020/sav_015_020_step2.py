...
from projects.mllm_labeling.datasets.text_dataset_vertify import SAM2TextDataset_Consistency
...
save_folder = './whole_pesudo_cap_v3/sav_015_020_step2/'

# Data paths
json_folder = './whole_pesudo_cap_v3/sav_015_020_step1/'
...
test_dataset = [dict(
    type=SAM2TextDataset_Consistency,
