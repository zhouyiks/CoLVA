...
data_sam2_expression_file = './whole_pesudo_cap/sam_v_final_shortcap_v2.json'
video_sam2_dataset_short = dict(
...
train_dataset = dict(
    type=ConcatDataset, datasets=[
        ...
        # sam2
        video_sam2_dataset_short, video_sam2_dataset_long,
    ]
)
