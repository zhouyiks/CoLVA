...
from projects.glamm.models.region_encoder import MLVLROIQueryModule
from projects.glamm.datasets import RefCocoGRegionDataset, VisualGenomeRegionDataset
...
#######################################################################
refcocog_region_dataset = dict(
    type=RefCocoGRegionDataset,
    image_folder='data/coco/train2014/',
    image_processor=image_processor,
    data_path='data/mdetr_annotations/finetune_refcocog_train.json',
    tokenizer=tokenizer,
    ...
    repeats=1,
    num_classes_per_sample=10,
    extra_image_processor=None)

vg_region_dataset = dict(
    type=VisualGenomeRegionDataset,
...
train_dataset = dict(
    type=ConcatDataset, datasets=[
        refcocog_region_dataset, vg_region_dataset
    ])
