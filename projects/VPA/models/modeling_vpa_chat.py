...
from .configuration_vpa_chat import VPAConfig
...
class VPAModel(PreTrainedModel):
    config_class = VPAConfig
    ...
    def __init__(self, config: VPAConfig, vision_model=None, language_model=None, use_flash_attn=True):
