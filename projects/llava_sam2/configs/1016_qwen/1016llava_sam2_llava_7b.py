...
from transformers import AutoTokenizer, CLIPImageProcessor, CLIPVisionModel, AutoModelForCausalLM
...
from projects.llava_sam2.models import VideoLLaVASAMModel, SAM2TrainRunner
...
from vlm.engine.hooks.dataset_info_hook import SpecialDatasetInfoHook
...
#######################################################################
# Model
path = 'pretrained/llava/llava-1.5-7b-hf/'
pretrained_pth = None
...
custom_hooks = [
    dict(type=SpecialDatasetInfoHook, tokenizer=tokenizer, special_tokens=special_tokens),
]
