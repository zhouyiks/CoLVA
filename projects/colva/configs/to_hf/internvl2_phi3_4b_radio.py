...
from projects.colva.dataset.map_fns import (
    llava_map_fn, match_reasoning_map_fn, match_choice_only_map_fn,
)
...
radio_adapter_weight = "./pretrained_weights/internvl2_4b_radio_adapter_iter11792.pth"
...
model = dict(
    ...
    pretrained_pth="./pretrained_weights/internvl2_4b_radio_llm_lora_sft_iter18252.pth",
    radio_pretrained_pth=radio_adapter_weight,
)
...
match_reasoning_dataset = dict(
    ...
    dataset_map_fn=match_reasoning_map_fn,
