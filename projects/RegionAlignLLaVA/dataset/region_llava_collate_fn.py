...
def region_llava_collate_fn(instances: Sequence[Dict],
    ...
    has_mask = any(inst.get('region_masks') is not None for inst in instances)
    ...
    for example in instances:
        ...
        if has_mask:
            if 'region_masks' in example.keys() and example['region_masks'] is not None:
                object_masks.append(example['region_masks'])
    ...
    if has_mask:
        data_dict['region_masks'] = object_masks
