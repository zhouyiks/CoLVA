...
from projects.mllm_labeling.datasets.text_dataset_vertify import SAM2TextDataset_ShortCap_whole
...
save_folder = './whole_pesudo_cap/short_cap/'

# Data paths
json_file = './whole_pesudo_cap/sam_v_final_v2.json'
...
test_dataset = [dict(
    type=SAM2TextDataset_ShortCap_whole,
    json_file=json_file,
    bs=8,
)]
