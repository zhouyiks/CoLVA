...
gcg_val_image_folder = "data/glamm_data/images/grandf/val_test/"

demo_items = []

img_file_names = os.listdir(gcg_val_image_folder)[:100]
print([img_file_names[idx] for idx in [0, 7, 27, 69, 62, 43]])
for image_name in os.listdir(gcg_val_image_folder)[:100]:
    img_path = os.path.join(gcg_val_image_folder, image_name)
    demo_items.append({'image_path': img_path, 'question': '<image>\nCould you please give me a brief description of the image? Please respond with interleaved segmentation masks for the corresponding parts of the answer.'})
...
#
#     # {'image_path': './work_dirs/demo_figs/canoe-7541311_1280.jpg', 'question': '<image>Can you provide me with a detailed description of the region in the picture marked by region1.', 'vp': True},
#     # {'image_path': './work_dirs/demo_figs/canoe-7541311_1280.jpg', 'question': '<image>Can you provide me with a detailed description of the region in the picture marked by region2.', 'vp': True},
#     # {'image_path': './work_dirs/demo_figs/canoe-7541311_1280.jpg', 'question': '<image>Can you provide me with a detailed description of the region in the picture marked by region3.', 'vp': True},
#     # {'image_path': './work_dirs/demo_figs/canoe-7541311_1280.jpg', 'question': '<image>Can you provide me with a detailed description of the region in the picture marked by region4.', 'vp': True},
#     # {'image_path': './work_dirs/demo_figs/canoe-7541311_1280.jpg', 'question': '<image>Can you provide me with a detailed description of the region in the picture marked by region5.', 'vp': True},
#     # {'image_path': './work_dirs/demo_figs/canoe-7541311_1280.jpg', 'question': '<image>Can you provide me with a detailed description of the region in the picture marked by region6.', 'vp': True},
#     #
